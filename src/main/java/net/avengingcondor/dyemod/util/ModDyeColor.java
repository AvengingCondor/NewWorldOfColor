...
public enum ModDyeColor implements StringRepresentable {
    ...
    CRIMSON(16, "crimson", 7801868, MapColor.NETHER, 15790321, 8388608, DyeColor.RED),
    VERMILION(17, "vermilion", 13714715, MapColor.TERRACOTTA_ORANGE, 15790322, 14889475, DyeColor.ORANGE),
    AMBER(18, "amber", 16690214, MapColor.TERRACOTTA_YELLOW, 15790323, 16766720, DyeColor.YELLOW),
    CHARTREUSE(19, "chartreuse", 14412098, MapColor.COLOR_YELLOW, 15790324, 14483247, DyeColor.YELLOW),
    OLIVE(20, "olive", 9154880, MapColor.GRASS, 15790325, 8300077, DyeColor.LIME),
    LIGHT_GREEN(21, "light_green", 5233999, MapColor.EMERALD, 15790326, 3329330, DyeColor.LIME),
    JADE(22, "jade", 1994014, MapColor.PLANT, 15790327, 25600, DyeColor.GREEN),
    TEAL(23, "teal", 5359278, MapColor.WARPED_STEM, 15790328, 2285752, DyeColor.CYAN),
    TURQUOISE(24, "turquoise", 6155732, MapColor.WARPED_WART_BLOCK, 15790329, 8388564, DyeColor.CYAN),
    AZURE(25, "azure", 5339114, MapColor.LAPIS, 15790330, 2003199, DyeColor.LIGHT_BLUE),
    INDIGO(26, "indigo", 6367719, MapColor.COLOR_PURPLE, 15790332, 4325573, DyeColor.BLUE),
    MAUVE(27, "mauve", 11630307, MapColor.ICE, 15790340, 12014058, DyeColor.PURPLE),
    FUCHSIA(28, "fuchsia", 11806079, MapColor.COLOR_MAGENTA, 15790333, 13896842, DyeColor.MAGENTA),
    BURGUNDY(29, "burgundy", 10107241, MapColor.WARPED_HYPHAE, 15790334, 9437268, DyeColor.PINK),
    CORAL(30, "coral", 15163771, MapColor.COLOR_PINK, 15790335, 14381203, DyeColor.PINK),
