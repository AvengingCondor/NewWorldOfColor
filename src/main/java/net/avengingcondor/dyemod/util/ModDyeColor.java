...
public enum ModDyeColor implements StringRepresentable {
    ...
    TURQUOISE(24, "turquoise", 9303250, MapColor.WARPED_WART_BLOCK, 15790329, 8388564),
    AZURE(25, "azure", 5339114, MapColor.LAPIS, 15790330, 2003199),
    INDIGO(26, "indigo", 5584333, MapColor.COLOR_PURPLE, 15790332, 4325573),
    MAUVE(27, "mauve", 11630307, MapColor.ICE, 15790340, 12014058),
    FUCHSIA(28, "fuchsia", 12930456, MapColor.COLOR_MAGENTA, 15790333, 13896842),
    BURGUNDY(29, "burgundy", 10107241, MapColor.WARPED_HYPHAE, 15790334, 9437268),
    CORAL(30, "coral", 15174290, MapColor.COLOR_PINK, 15790335, 14381203),
    LIGHT_BROWN(31, "light_brown", 12616787, MapColor.PODZOL, 15790336, 13468991);
    ...
    private ModDyeColor(int id, String name, int textureDefuseColor, MapColor mapColor, int fireworkColor, int textColor) {
        this.id = id;
        this.name = name;
